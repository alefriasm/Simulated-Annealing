...
// Funciones de contar capas, HS (LO AGREGUE YO)
  int enqc(set<int>* capas, int num_capas, int node);
  double hierarchical_score(set<int>* capas, int num_capas);
  void informacion_capas(set<int>* capas, int num_capas);
  int Nd_obs, Nu_obs, Nh_obs;
  double corrected_hierarchical_score(int Nd_obs, int Nu_obs, int Nh_obs, int Nd_exp, int Nu_exp, int Nh_exp);
  int cal_nodos_obs(const std::set<int>& capa);
  int cal_nodos_esp(const std::set<int>& capa);
  double probabilistic_hierarchical_score(set<int>* capas, int num_capas, int num_nodes);
  void probabilidad(set<int>* capas, int num_capas, int num_nodes, double* probabilidades);
